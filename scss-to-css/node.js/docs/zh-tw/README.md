...
<a href="https://github.com/adamlui/js-utils/releases/tag/scss-to-css-1.8.5"><img height=31 src="https://img.shields.io/badge/最新版本-1.8.5-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
參數選項：
 ...
 --comment="comment"                      在縮小的 CSS 前面加入註解。 使用 '\n' 按行分隔。
