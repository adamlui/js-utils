...
<a href="https://github.com/adamlui/js-utils/releases/tag/scss-to-css-1.9.0"><img height=31 src="https://img.shields.io/badge/最新のビルド-1.9.0-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
パラメータオプション:
 ...
 --comment="comment"                      コンパイルされた CSS の先頭にコメントを追加します。'\n' を使用して行で区切ります。
...
`comment`     | 文字列   | コンパイルされた CSS の先頭に追加するコメント。 「\n」を使用して行で区切ります。 | `''`
