...
बुलियन पर्याय:
 ...
 -C, --clone-folders                      आउटपुट डिरेक्टरीमध्ये फोल्डरची रचना जतन करा.
...
`cloneFolders` | बुलियन | आउटपुट डिरेक्टरीमध्ये फोल्डरची रचना जतन करा.                                  | `false`
`ignores`      | रचना  | संकलनातून वगळायच्या फाइल्स/डिरेक्टरीज.                                         | `[]`
