...
<a href="https://www.npmjs.com/package/@adamlui/scss-to-css?activeTab=versions"><img height=31 src="https://img.shields.io/badge/Latest_Build-1.6.1-lightgrey.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
झेंडा                             | वर्णन
--------------------------------|------------------------------------------------------------------
`-n` किंवा `--dry-run`            | फाइल(स्) प्रत्यक्षात कमी करू नका, त्यांच्यावर प्रक्रिया केली जाईल का ते दाखवा.
`-d` किंवा `--include-dotfolders` | फाइल शोधात डॉटफोल्डर समाविष्ट करा.
`-S` किंवा `--no-source-maps`     | स्रोत नकाशे तयार होण्यापासून प्रतिबंधित करा.
`-M` किंवा `--no-minify`          | आउटपुट CSS चे मिनिफिकेशन अक्षम करा.
`-R` किंवा `--no-recursion`       | आवर्ती फाइल शोध अक्षम करा.
`-q` किंवा `--quiet`              | त्रुटी वगळता सर्व लॉगिंग दाबा.

#### माहिती आदेश:

आज्ञा                  | वर्णन
----------------------|----------------------
`-h` किंवा `--help`    | मदत स्क्रीन प्रदर्शित करा.
`-v` किंवा `--version` | आवृत्ती क्रमांक दर्शवा.
