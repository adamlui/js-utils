...
ਝੰਡਾ                            | ਵਰਣਨ
-------------------------------|---------------------------------------------------------------------------
`-n` ਜਾਂ `--dry-run`            | ਅਸਲ ਵਿੱਚ ਫਾਈਲਾਂ ਨੂੰ ਕੰਪਾਇਲ ਨਾ ਕਰੋ, ਸਿਰਫ਼ ਦਿਖਾਓ ਕਿ ਕੀ ਉਹਨਾਂ 'ਤੇ ਕਾਰਵਾਈ ਕੀਤੀ ਜਾਵੇਗੀ।
`-d` ਜਾਂ `--include-dotfolders` | ਫਾਈਲ ਖੋਜ ਵਿੱਚ ਡਾਟਫੋਲਡਰ ਸ਼ਾਮਲ ਕਰੋ।
`-S` ਜਾਂ `--no-source-maps`     | ਸਰੋਤ ਨਕਸ਼ੇ ਤਿਆਰ ਹੋਣ ਤੋਂ ਰੋਕੋ।
`-M` ਜਾਂ `--no-minify`          | ਆਉਟਪੁੱਟ CSS ਦੀ ਮਿਨੀਫਿਕੇਸ਼ਨ ਨੂੰ ਅਸਮਰੱਥ ਬਣਾਓ।
`-R` ਜਾਂ `--no-recursion`       | ਆਵਰਤੀ ਫਾਈਲ ਖੋਜ ਨੂੰ ਅਸਮਰੱਥ ਬਣਾਓ।
`-q` ਜਾਂ `--quiet`              | ਗਲਤੀਆਂ ਨੂੰ ਛੱਡ ਕੇ ਸਾਰੇ ਲੌਗਿੰਗ ਨੂੰ ਦਬਾਓ।

#### ਜਾਣਕਾਰੀ ਹੁਕਮ:

ਹੁਕਮ                | ਵਰਣਨ
--------------------|------------------
`-h` ਜਾਂ `--help`    | ਡਿਸਪਲੇ ਮਦਦ ਸਕ੍ਰੀਨ।
`-v` ਜਾਂ `--version` | ਵਰਜਨ ਨੰਬਰ ਦਿਖਾਓ।
