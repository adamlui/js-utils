...
<a href="https://github.com/adamlui/js-utils/releases/tag/scss-to-css-2.4.5">
    <img height=31 src="https://img.shields.io/badge/最新のビルド-2.4.5-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
<a href="#%EF%B8%8F-mit-ライセンス">
    <img height=31 src="https://img.shields.io/badge/ライセンス-MIT-f99b27.svg?logo=internetarchive&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
<a href="https://sonarcloud.io/component_measures?metric=vulnerabilities&selected=adamlui_js-utils%3Ascss-to-css&id=adamlui_js-utils">
    <img height=31 src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fsonarcloud.io%2Fapi%2Fmeasures%2Fcomponent%3Fcomponent%3Dadamlui_scss-to-css%3Asrc%2Fscss-to-css.js%26metricKeys%3Dvulnerabilities&query=%24.component.measures.0.value&style=for-the-badge&logo=sonar&logoColor=white&labelColor=464646&label=%E8%84%86%E5%BC%B1%E6%80%A7&color=ffef00"></a>
...
- `[output_path]`: CSSファイルとソースマップファイルが保存されるファイルまたはディレクトリへのパス。入力ルートからの相対パスで指定します（指定しない場合は `css/` が使用されます）。
...
**特定のディレクトリ**内のすべての SCSS ファイルをコンパイルします (`css/path/to/your/directory/` に出力されます):

```
$ scss-to-css path/to/your/directory
```

**特定のファイル**をコンパイルします (`css/path/to/your/file.min.css` に出力されます):
...
ブール値のオプション:
 ...
 -r, --relative-output                    出力ファイルは、入力ルートではなく、各ソースファイルからの相対パスで指定されます。
...
`relativeOutput` | ブール値 | 出力ファイルは、入力ルートではなく、各ソースファイルからの相対パスで指定されます。       | `false`
...
<br>[インストール](https://github.com/adamlui/minify.js/tree/main/node.js/#-installation) /
[お読みください](https://github.com/adamlui/minify.js/tree/main/node.js/#readme) /
[CLI の使用法](https://github.com/adamlui/minify.js/tree/main/node.js/#-command-line-usage) /
[API の使用法](https://github.com/adamlui/minify.js/tree/main/node.js/#-api-usage) /
