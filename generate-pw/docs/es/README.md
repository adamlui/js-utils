...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.0"><img height=31 src="https://img.shields.io/badge/Ultima_Versión-1.5.0-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
**💡 Nota:** Para importar siempre la última versión (¡no se recomienda en producción!), elimine la etiqueta de versión `@1.5.0` de la URL de jsDelivr: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
