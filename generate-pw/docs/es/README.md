...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.17">
    <img height=31 src="https://img.shields.io/badge/Ultima_Versión-1.5.17-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
<a href="https://github.com/adamlui/js-utils/blob/generate-pw-1.5.17/generate-pw/dist/generate-pw.min.js">
    <img height=31 src="https://img.shields.io/github/size/adamlui/js-utils/generate-pw/dist/generate-pw.min.js?branch=generate-pw-1.5.17&label=Tama%C3%B1o%20Minimizado&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
**💡 Nota:** Para importar siempre la última versión (¡no se recomienda en producción!), elimine la etiqueta de versión `@1.5.17` de la URL de jsDelivr: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
