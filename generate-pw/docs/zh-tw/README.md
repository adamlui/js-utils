...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.4.4"><img height=31 src="https://img.shields.io/badge/最新版本-1.4.4-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
**💡 注意:** 若要始終匯入最新版本（不建議在生產中使用！），請從 jsDelivr URL 中刪除 `@1.4.4` 版本標籤：`https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
