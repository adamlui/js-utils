...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.14">
    <img height=31 src="https://img.shields.io/badge/最新版本-1.5.14-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
<a href="https://github.com/adamlui/js-utils/blob/generate-pw-1.5.14/generate-pw/dist/generate-pw.min.js">
    <img height=31 src="https://img.shields.io/github/size/adamlui/js-utils/generate-pw/dist/generate-pw.min.js?branch=generate-pw-1.5.14&label=%E7%B8%AE%E5%B0%8F%E5%B0%BA%E5%AF%B8&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
```html
<script src="https://cdn.jsdelivr.net/npm/generate-pw@1.5.14/dist/generate-pw.min.js"></script>
```
...
```js
...
// @require https://cdn.jsdelivr.net/npm/generate-pw@1.5.14/dist/generate-pw.min.js
// ==/UserScript==
...
**💡 注意:** 若要始終匯入最新版本（不建議在生產中使用！），請從 jsDelivr URL 中刪除 `@1.5.14` 版本標籤：`https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
