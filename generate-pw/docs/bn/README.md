...
**generate-pw** একটি ECMAScript মডিউল বা একটি CommonJS মডিউল হিসাবে আপনার অ্যাপে আমদানি করা যেতে পারে৷
...
**💡 দ্রষ্টব্য:** একাধিক ফলাফল তৈরি করতে, পাস করুন `--qty=n` যেখানে `n` হল পাসওয়ার্ডের সংখ্যা।
