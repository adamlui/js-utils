...
**💡 দ্রষ্টব্য:** সর্বদা সর্বশেষ সংস্করণ আমদানি করতে (উৎপাদনে প্রস্তাবিত নয়!) jsDelivr URL থেকে `@1.5.17` সংস্করণ ট্যাগটি সরান: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
...
বুলিয়ান বিকল্প:
 ...
 -r, --similar-chars         পাসওয়ার্ডে একই রকম অক্ষর অন্তর্ভুক্ত করুন।
...
```js
export default {
    length: 8,                  // জেনারেট করা পাসওয়ার্ডের দৈর্ঘ্য
    ...
    excludeNums: false,         // পাসওয়ার্ডে সংখ্যা ব্যবহার করা যাবে না
    excludeSymbols: false,      // পাসওয়ার্ডে প্রতীক ব্যবহার করা যাবে না
    excludeLowerChars: false,   // পাসওয়ার্ডে ছোট হাতের অক্ষর ব্যবহারের অনুমতি দেবেন না
