...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.5"><img height=31 src="https://img.shields.io/badge/Dernière_version-1.5.5-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
**💡 Remarque:** Pour toujours importer la dernière version (non recommandé en production!), supprimez la balise de version `@1.5.5` de l'URL jsDelivr: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
