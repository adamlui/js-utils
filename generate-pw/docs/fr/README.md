...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.14">
    <img height=31 src="https://img.shields.io/badge/Dernière_version-1.5.14-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
<a href="https://github.com/adamlui/js-utils/blob/generate-pw-1.5.14/generate-pw/dist/generate-pw.min.js">
    <img height=31 src="https://img.shields.io/github/size/adamlui/js-utils/generate-pw/dist/generate-pw.min.js?branch=generate-pw-1.5.14&label=Taille%20r%C3%A9duite&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
**💡 Remarque:** Pour toujours importer la dernière version (non recommandé en production!), supprimez la balise de version `@1.5.14` de l'URL jsDelivr: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
