...
<a href="https://github.com/adamlui/js-utils/releases/tag/generate-pw-1.5.1"><img height=31 src="https://img.shields.io/badge/Neueste_Version-1.5.1-44cc11.svg?logo=icinga&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
**💡 Hinweis:** Um immer die neueste Version zu importieren (in der Produktion nicht empfohlen!), entfernen Sie das Versions-Tag `@1.5.1` aus der jsDelivr-URL: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
...
<br>[Installieren](https://docs.js-utils.com/generate-ip/#-installation) /
