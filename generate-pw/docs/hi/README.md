...
**💡 ध्यान दें:** हमेशा नवीनतम संस्करण आयात करने के लिए (उत्पादन में अनुशंसित नहीं!) jsDelivr URL से `@1.5.17` संस्करण टैग हटा दें: `https://cdn.jsdelivr.net/npm/generate-pw/dist/generate-pw.min.js`
...
```js
export default {
    length: 8,                  // जेनरेट होने वाले पासवर्ड की लंबाई
    ...
    includeNums: false,         // पासवर्ड में नंबर की अनुमति दें
    includeSymbols: false,      // पासवर्ड में सिंबल की अनुमति दें
    ...
    excludeSimilarChars: false, // पासवर्ड में मिलते-जुलते कैरेक्टर को हटा दें
    strictMode: false,          // पासवर्ड में हर अनुमत कैरेक्टर सेट से 1+ कैरेक्टर ज़रूरी है
