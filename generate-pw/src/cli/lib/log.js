module.exports = {
    ...
    error(...args) { console.error(`\n${this.colors.br}${cli.msgs.prefix_error}:`, ...args, this.colors.nc) },
    ...
    warn(...args) { console.warn(`\n${this.colors.bo}${cli.msgs.prefix_warning}:`, ...args, this.colors.nc) },
    ...
    help(includeSections = ['header', 'usage', 'params', 'flags', 'cmds']) {
        ...
        const helpSections = {
            ...
            flags: [
                ...
                ` -e, --entropy               ${cli.msgs.optionDesc_entropy}.`,
