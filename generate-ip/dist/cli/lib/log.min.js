...
${this.colors.bw}o ${app.msgs.helpSection_params}:`+this.colors.nc,` --qty=n                     ${app.msgs.optionDesc_qty}.`,` --config="path/to/file"     ${app.msgs.optionDesc_config}.`],flags:[`
${this.colors.bw}o ${app.msgs.helpSection_flags}:`+this.colors.nc,` -6, --ipv6                  ${app.msgs.optionDesc_ipv6}.`,` -m, --mac                   ${app.msgs.optionDesc_mac}.`,` -q, --quiet                 ${app.msgs.optionDesc_quiet}.`],cmds:[`
${this.colors.bw}o ${app.msgs.helpSection_cmds}:`+this.colors.nc,` -i, --init                  ${app.msgs.optionDesc_init}.`,` -h, --help                  ${app.msgs.optionDesc_help}.`,` -v, --version               ${app.msgs.optionDesc_version}.`]};s.forEach(c=>o[c]?.forEach(o=>{{var r=/header|usage/.test(c)?1:29;let e=process.stdout.columns||80,s=o.match(/\S+|\s+/g),p=[],i="";s.forEach(s=>{var o=e-(p.length?r:0);i.length+"| ".length+s.length>o&&(p.push(p.length?i.trimStart():i),i=""),i+=s}),p.push(p.length?i.trimStart():i),p.forEach((s,o)=>console.info("| "+(0==o?s:" ".repeat(r)+s)))}})),console.info(`
