...
├ `+n+copyright,n+"Source: "+srcURL,n+"Doc: "+docURL],usage:[`
...
${bw}o Info commands:`+nc," -h, --help                  Display help screen."," -v, --version               Show version number."]};e.forEach(s=>{i[s]?.forEach(e=>{{var o=/header|usage/.test(s)?1:29;const r=process.stdout.columns||80,t=[],n=e.match(/\S+|\s+/g);let i="";n.forEach(e=>{var n=r-(0==t.length?0:o);i.length+"| ".length+e.length>n&&(t.push(0==t.length?i:i.trimStart()),i=""),i+=e}),t.push(0==t.length?i:i.trimStart()),t.forEach((e,n)=>console.info("| "+(0==n?e:" ".repeat(o)+e)))}})})}function printHelpCmdAndDocURL(){console.info(`
