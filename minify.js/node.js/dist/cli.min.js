 ...
 */
let pkgName="@adamlui/minify.js",copyright="© 2024–2025 Adam Lui & contributors under the MIT license.",cmdFormat="minify-js [inputPath] [outputPath] [options]",srcURL="https://code.minify-js.org/node.js",docURL="https://docs.minify-js.org/node.js/#-command-line-usage",latestLocaleCommitHash="b9884c6";(async()=>{let n=require(__dirname.match(/src/)?"./minify":"./minify.min"),a=require("fs"),c=require("path"),r=require("node-clipboardy"),i=require("child_process").execSync,s="[0m",m="[1;91m",d="[1;33m",f="[1;92m",p="[1;97m",g="en";if("win32"==process.platform)try{g=i("(Get-Culture).TwoLetterISOLanguageName",{shell:"powershell",encoding:"utf-8"}).trim()}catch(e){b("Error loading system language: "+e)}else{var h=process.env;g=(h.LANG||h.LANGUAGE||h.LC_ALL||h.LC_MESSAGES||h.LC_NAME||"en").split(".")[0]}let u={};h=new Promise((r,s)=>{let t=`https://cdn.jsdelivr.net/gh/adamlui/minify.js@bbdca44e20bc8f16a41b066949c7a501ac35386d/_locales/`,e=`${g?g.replace("-","_"):"en"}/`,l=t+e+"messages.json",a=0;_(l).then(async function o(i){try{let e=await i.json(),o={};for(var n in e)"object"==typeof e[n]&&"message"in e[n]&&(o[n]=e[n].message);r(o)}catch(e){if(3==++a)return r({});_(l=g.includes("-")&&1==a?l.replace(/([^_]*)_[^/]*(\/.*)/,"$1$2"):t+"en/messages.json").then(o).catch(s)}}).catch(s)});try{u=await h}catch(e){b("Error fetching messages: "+e)}let $={},t={flags:{dryRun:/^--?(?:n|dry-?run)$/,includeDotFolders:/^--?(?:dd?|(?:include-?)?dot-?(?:folder|dir(?:ector(?:y|ie))?)s?=?(?:true|1)?)$/,includeDotFiles:/^--?(?:df|D|(?:include-?)?dot-?files?=?(?:true|1)?)$/,noRecursion:/^--?(?:R|(?:disable|no)-?recursi(?:on|ve)|recursi(?:on|ve)=(?:false|0))$/,noMangle:/^--?(?:M|(?:disable|no)-?mangle|mangle=(?:false|0))$/,noFilenameChange:/^--?(?:X|(?:disable|no)-?(?:file)?name-?change|(?:file)?name-?change=(?:false|0))$/,noRewriteImports:/^--?(?:I|(?:disable|no)-?rewrite-?imports|rewrite-?imports=(?:false|0))$/,cloneFolders:/^--?(?:C|clone-?folders?=?(?:true|1)?)$/,copy:/^--?c(?:opy)?$/,quietMode:/^--?q(?:uiet)?(?:-?mode)?$/},paramOptions:{ignoreFiles:/^--?(?:ignore|skip|exclude)(?:d?-?files?)?(?:=.*|$)/,comment:/^--?comments?(?:=.*|$)/},infoCmds:{help:/^--?h(?:elp)?$/,version:/^--?ve?r?s?i?o?n?$/}};if(process.argv.forEach(o=>{var e,i,n;o.startsWith("-")&&(n=Object.keys(t.flags).find(e=>t.flags[e].test(o)),e=Object.keys(t.paramOptions).find(e=>t.paramOptions[e].test(o)),i=Object.keys(t.infoCmds).find(e=>t.infoCmds[e].test(o)),n?$[n]=!0:e?(/=.+/.test(o)||(console.error(`
${m+(u.prefix_error||"ERROR")}: `+`Arg [--${o.replace(/-/g,"")}] `+`${u.error_noEqual||"requires '=' followed by a value"}.${s}`),j(),process.exit(1)),n=o.split("=")[1],$[e]=parseInt(n)||n):i||(console.error(`
...
${d+(u.info_noFilesWillBeMinned||"No JS files will be minified")}.[0m`);else{let i=[],e=[];$.cloneFolders&&a.statSync(o).isDirectory()?(y=n.minify(o,{verbose:!$.quietMode,mangle:!$.noMangle,comment:$.comment?.replace(/\\n/g,"\n"),cloneFolders:!0,recursive:!$.noRecursion,dotFolders:!!$.includeDotFolders,dotFiles:!!$.includeDotFiles,rewriteImports:!$.noRewriteImports,ignoreFiles:$.ignoreFiles?$.ignoreFiles.split(",").map(e=>e.trim()):[]}),Array.isArray(y)?e=y:y&&y.error?i.push(o):y&&(e=[y])):e=h.map(e=>{var o=n.minify(e,{verbose:!$.quietMode,mangle:!$.noMangle,comment:$.comment?.replace(/\\n/g,"\n")});return o.error&&i.push(e),o}).filter(e=>!e.error),e?.length?(b(`
${f+(u.info_minComplete||"Minification complete")}![0m`),b(p+e.length+" "+(u.info_file||"file")+`${1<e.length?"s":""} ${u.info_minified||"minified"}.${s}`)):b(`
${d+(u.info_noFilesProcessed||"No unminified JavaScript files processed")}.[0m`),i.length&&(b(`
${m+i.length} `+(u.info_file||"file")+`${1<i.length?"s":""} ${u.info_failedToMinify||"failed to minify"}:${s}`),i.forEach(e=>b(e))),0!=e?.length&&($.copy&&1==e?.length?(console.log(`
`+p+e[0].code+s),b(`
${u.info_copying||"Copying to clipboard"}...`),r.writeSync(e[0].code)):(b(`
${u.info_writing||"Writing to file"}${1<e?.length?"s":""}...`),e?.forEach(({code:e,srcPath:i,relPath:n})=>{let r,s;if($.cloneFolders&&n&&l){let e=c.resolve(process.cwd(),l),o=c.dirname(n);r="."!=o?c.join(e,o):e,s=c.basename(i,".js")+`${$.noFilenameChange?"":".min"}.js`}else r=c.join(c.dirname(i),(/so?u?rce?$/.test(c.dirname(i))?"../":"")+(l.endsWith(".js")?c.dirname(l):l||"min")),s=(l.endsWith(".js")&&t.endsWith(".js")?c.basename(l).replace(/(\.min)?\.js$/,""):c.basename(i,".js"))+`${$.noFilenameChange?"":".min"}.js`;let o=c.join(r,s);a.existsSync(r)||a.mkdirSync(r,{recursive:!0}),a.writeFileSync(o,e,"utf8"),b(`  ${f}✓[0m `+c.relative(process.cwd(),o))})))}}function _(n){return new Promise((i,e)=>{var o=n.match(/^([^:]+):\/\//)[1];/^https?$/.test(o)||e(new Error(`${u.error_invalidURL||"Invalid URL"}.`)),require(o).get(n,e=>{let o="";e.on("data",e=>o+=e),e.on("end",()=>i({json:()=>JSON.parse(o)}))}).on("error",e)})}function v(e=["header","usage","pathArgs","flags","paramOptions","infoCmds"]){var o=`[106m[30m ${pkgName.replace(/^@[^/]+\//,"")} [0m `;let i={header:["\n├ "+o+(u.appCopyright||copyright),o+(u.prefix_source||"Source")+": "+srcURL],usage:[`
${p}o ${u.helpSection_usage||"Usage"}:[0m`,` ${p}» `+f+cmdFormat+s],pathArgs:[`
...
${p}o ${u.helpSection_infoCmds||"Info commands"}:[0m`," -h, --help                          "+(u.optionDesc_help||"Display help screen."),` -v, --version                       ${u.optionDesc_version||"Show version number"}.`]};e.forEach(t=>i[t]?.forEach(o=>{{var s=/header|usage/.test(t)?1:37;let i=process.stdout.columns||80,n=[],e=o.match(/\S+|\s+/g),r="";e.forEach(e=>{var o=i-(n.length?s:0);r.length+"| ".length+e.length>o&&(n.push(n.length?r.trimStart():r),r=""),r+=e}),n.push(n.length?r.trimStart():r),n.forEach((e,o)=>console.info("| "+(0==o?e:" ".repeat(s)+e)))}})),console.info(`
${u.info_moreHelp||"For more help"}, ${u.info_visit||"visit"}: `+p+docURL+s)}function j(){console.info(`
${u.info_moreHelp||"For more help"}, ${u.info_type||"type"} minify-js --help' ${u.info_or||"or"} ${u.info_visit||"visit"}
`+p+docURL+s)}function b(e){$.quietMode||console.info(e)}})();