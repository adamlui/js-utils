...
» minify-js . output.min.js`),n.helpCmdAndDocURL(),process.exit(1)));var d=l.endsWith(".js")&&!s.statSync(l).isDirectory()?[l]:i(l,{recursive:!cli.config.noRecursion,verbose:!cli.config.quietMode,ignores:(cli.config.ignores?.split(",")??[]).map(e=>e.trim())});env.debugMode||cli.config.dryRun?d.length?(n.info(cli.msgs.info_filesToBeMinned+":"),d.forEach(e=>n.dim(e))):n.info(cli.msgs.info_noFilesWillBeMinned+"."):e.js({srcFiles:d,inputPath:l,inputArg:t,outputArg:c})})();