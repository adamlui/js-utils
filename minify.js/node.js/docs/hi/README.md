...
बूलियन विकल्प:
 ...
 -I, --no-rewrite-imports             इम्पोर्ट पाथ को .js से .min.js में अपडेट करना डिसेबल करें।
 -c, --copy                           यदि एकल स्रोत फ़ाइल संसाधित होती है तो फ़ाइल में लिखने के बजाय क्लिपबोर्ड पर छोटा कोड कॉपी करें।
 -C, --clone-folders                  आउटपुट डायरेक्टरी में फ़ोल्डर स्ट्रक्चर को सुरक्षित रखें।
...
`rewriteImports` | बूलियन | इम्पोर्ट पाथ को .js से .min.js में अपडेट करें।                                    | `true`
`cloneFolders`   | बूलियन | आउटपुट डायरेक्टरी में फ़ोल्डर स्ट्रक्चर को सुरक्षित रखें।                               | `false`
