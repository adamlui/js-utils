...
बुलियन पर्याय:
 ...
 -I, --no-rewrite-imports             इम्पोर्ट पाथ्स .js वरून .min.js मध्ये अपडेट करणे अक्षम करा.
 -c, --copy                           सिंगल सोर्स फाइलवर प्रक्रिया केली असल्यास फाइलवर लिहिण्याऐवजी क्लिपबोर्डवर मिनिफाइड कोड कॉपी करा.
 -C, --clone-folders                  आउटपुट डिरेक्टरीमध्ये फोल्डरची रचना कायम ठेवा.
...
`rewriteImports` | बुलियन | इम्पोर्ट पाथ्स .js वरून .min.js मध्ये अपडेट करा.                                  | `true`
`cloneFolders`   | बुलियन | आउटपुट डिरेक्टरीमध्ये फोल्डरची रचना कायम ठेवा.                                   | `false`
