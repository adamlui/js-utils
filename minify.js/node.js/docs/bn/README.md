...
বুলিয়ান বিকল্প:
 ...
 -I, --no-rewrite-imports             ইম্পোর্ট পাথগুলো .js থেকে .min.js-এ আপডেট করা নিষ্ক্রিয় করুন।
 -c, --copy                           যদি একক উৎস ফাইল প্রক্রিয়া করা হয় তবে ফাইলে লেখার পরিবর্তে ক্লিপবোর্ডে মিনিফাইড কোড কপি করুন।
 -C, --clone-folders                  আউটপুট ডিরেক্টরিতে ফোল্ডার কাঠামো সংরক্ষণ করুন।
...
`rewriteImports` | বুলিয়ান | ইম্পোর্ট পাথগুলো .js থেকে .min.js-এ আপডেট করুন।                              | `true`
`cloneFolders`   | বুলিয়ান | আউটপুট ডিরেক্টরিতে ফোল্ডার কাঠামো সংরক্ষণ করুন।                                 | `false`
