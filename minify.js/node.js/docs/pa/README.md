...
ਬੁਲੀਅਨ ਵਿਕਲਪ:
 ...
 -I, --no-rewrite-imports             .js ਤੋਂ .min.js ਤੱਕ ਆਯਾਤ ਮਾਰਗਾਂ ਨੂੰ ਅੱਪਡੇਟ ਕਰਨਾ ਅਯੋਗ ਕਰੋ।
 ...
 -C, --clone-folders                  ਆਉਟਪੁੱਟ ਡਾਇਰੈਕਟਰੀ ਵਿੱਚ ਫੋਲਡਰ ਬਣਤਰ ਨੂੰ ਸੁਰੱਖਿਅਤ ਰੱਖੋ।
...
`rewriteImports` | ਬੁਲੀਅਨ   | .js ਤੋਂ .min.js ਤੱਕ ਆਯਾਤ ਮਾਰਗਾਂ ਨੂੰ ਅੱਪਡੇਟ ਕਰੋ।                                   | `true`
`cloneFolders`   | ਬੁਲੀਅਨ   | ਆਉਟਪੁੱਟ ਡਾਇਰੈਕਟਰੀ ਵਿੱਚ ਫੋਲਡਰ ਬਣਤਰ ਨੂੰ ਸੁਰੱਖਿਅਤ ਰੱਖੋ।                              | `false`
...
**ਕਾਪੀਰਾਈਟ © 2023–2025 [Adam Lui](https://github.com/adamlui) ਅਤੇ ਯੋਗਦਾਨ ਪਾਉਣ ਵਾਲੇ**
