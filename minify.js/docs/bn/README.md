...
**ডেভেলপার নির্ভরতা** হিসেবে (উদাহরণস্বরূপ, বিল্ড স্ক্রিপ্টের জন্য), আপনার প্রোজেক্ট রুট থেকে:

```
npm install -D @adamlui/minify.js
```

**রানটাইম নির্ভরতা** হিসেবে (উদাহরণস্বরূপ, অন-দ্য-ফ্লাই মিনিফিকেশনের জন্য), আপনার প্রোজেক্ট রুট থেকে:
