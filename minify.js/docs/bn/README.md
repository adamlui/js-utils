...
একটি **বিকাশকারী নির্ভরতা** হিসাবে, আপনার প্রকল্প রুট থেকে:
...
`<minify-js-cmd>` প্রতিস্থাপন করুন `minify-js` + ঐচ্ছিক আর্গুমেন্ট দিয়ে। তারপর, `npm run build:js` কমান্ডটি চালানোর জন্য ব্যবহার করা যেতে পারে।
<br><br>
...
আপনি এইভাবে আপনার অ্যাপে **minify.js** লোড করতে পারেন:

```js
const minifyJS = require('@adamlui/minify.js');
```

একটি একক উচ্চ স্তরের ফাংশন আছে, `minify(input, options)`, যা স্ট্রিং ইনপুটের সাথে খাপ খায় এমন কনফিগারযোগ্য পদ্ধতিতে সমস্ত মিনিফেকশন/পুনরাবৃত্তির পর্যায়গুলি সম্পাদন করবে।

### minify(options)

বিকল্পগুলি হল বুলিয়ান (ডিফল্টরূপে `true` হিসাবে সেট করা) বস্তুর বৈশিষ্ট্য হিসাবে পাস করা হয় যেমন `minifyJS.minify(input, { option: true })`:

```
 recursive     ডিরেক্টরি পাথ পাস হলে নেস্টেড ফাইলগুলির জন্য পুনরাবৃত্তিমূলকভাবে অনুসন্ধান করুন।
 verbose       কনসোল/টার্মিনালে লগইন দেখান।
```

### minify(input)

ইনপুট হল একটি স্ট্রিং যা সোর্স কোড বা পাথকে প্রতিনিধিত্ব করে।
...
**কপিরাইট  (c) 2023–2024 [Adam Lui](https://github.com/adamlui)**
