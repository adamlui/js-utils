...
झंडा                            | विवरण
-------------------------------|----------------------------------------------------------------------
`-n` या `--dry-run`            | वास्तव में फ़ाइल(फ़ाइलों) को छोटा न करें, बस यह दिखाएं कि क्या उन्हें संसाधित किया जाएगा।
`-d` या `--include-dotfolders` | फ़ाइल खोज में डॉटफ़ोल्डर शामिल करें।
`-D` या `--include-dotfiles`   | फ़ाइल खोज में डॉटफ़ाइलें शामिल करें।
`-R` या `--no-recursion`       | पुनरावर्ती फ़ाइल खोज अक्षम करें।
`-M` या `--no-mangle`          | नामों में गड़बड़ी अक्षम करें।
